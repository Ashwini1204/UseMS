...
import com.infy.infycart.user.service.CartService;
...
public class CartController {
	...
	public ResponseEntity<List<ProductDTO>> getAllWishListByBuyerId(@PathVariable Integer buyerId){
		...
		for(CartDTO cartDTO : cartsDTO) {
			ProductDTO productDTO = new RestTemplate().getForObject("http://localhost:7200/api/productid/"+cartDTO.getProdId(), ProductDTO.class);
