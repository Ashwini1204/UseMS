package com.infy.infycart.user.controller;
...
import com.infy.infycart.user.dto.ProductDTO;
import com.infy.infycart.user.dto.WishlistDTO;
import com.infy.infycart.user.service.WishlistService;
...
public class WishlistController {
	...
	public ResponseEntity<List<ProductDTO>> getAllWishListByBuyerId(@PathVariable Integer buyerId){
		...
		for(WishlistDTO wishlistDTO : wishlistsDTO) {
			ProductDTO productDTO = new RestTemplate().getForObject("http://localhost:7200/api/productid/"+wishlistDTO.getProdId(), ProductDTO.class);
